...
def create_multi_input_columns(train, test, column, prefix):
...
train_languages, test_languages = create_multi_input_columns(
    X_train,
    X_test,
    "LanguageHaveWorkedWith",
    "Language_"
...
train_databases, test_databases = create_multi_input_columns(
    X_train,
    X_test,
    "DatabaseHaveWorkedWith",
    "Database_"
